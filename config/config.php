...
$host = 'localhost'; // أو عنوان الخادم الخاص بقاعدة البيانات
$db   = 'chat_app';  // اسم قاعدة البيانات
$user = 'root';      // اسم المستخدم لقاعدة البيانات
$pass = '';          // كلمة مرور قاعدة البيانات
$charset = 'utf8mb4'; // ترميز الأحرف


$dsn = "mysql:host=$host;dbname=$db;charset=$charset"; // تعريف مصدر البيانات (Data Source Name)
$options = [
